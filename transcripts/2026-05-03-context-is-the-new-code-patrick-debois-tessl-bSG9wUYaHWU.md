---
description: Transcription brute de la vidéo YouTube "Context Is the New Code — Patrick Debois, Tessl".
...
[0:07] [music]
[0:14] >> There's there's a few people who want to
[0:16] start earlier.
[0:17] I know I'm going to take the opportunity
[0:19] to officially open kind of the
[0:22] architect track. There's no track host,
[0:24] so I do it myself. So, thank you for
[0:25] coming here. I hope you already had like
[0:27] a good conference. Um
[0:30] It's amazing that like so many people
[0:31] showed up. Um maybe before I start, um
[0:35] who's used any AI coding agent in this
[0:37] room? Raise your hand.
[0:40] Like lower it. Who hasn't? Raise your
[0:43] hand.
[0:44] Okay, my kind of people. Perfect. All
[0:46] right.
[0:48] Um
[0:50] Okay. Context is a new code.
[0:54] Or context development life cycle. Um I
[0:56] feel honored to be here. Every time I
[0:58] try to do a different talk at the AI
[1:00] engineering.
[1:01] So, this is a little bit of um
[1:04] you know, thinking ahead. It's an
[1:05] unpolished thought. It's not like
[1:08] everything's there, but is there
[1:10] anything there in AI anyway? But
[1:14] So,
[1:15] let's start.
[1:17] I assume
[1:19] you all are now vibe coding with
[1:21] prompts. I barely touch anymore kind of
[1:24] the code. I just tell the AI to do
[1:26] something different.
[1:28] So, I would say like
[1:31] context is the new code because it's
[1:33] being generated.
[1:35] A little bit more advanced maybe is
[1:38] I see myself having a tendency is I had
[1:41] large pieces of code that I was using
[1:44] maybe some helpers and some other
[1:45] pieces.
[1:47] And I just turned them into a skill.
[1:50] We had that in our into our product. It
[1:52] was an onboarding from, you know, AI
[1:55] agents. Um
[1:56] People have Python, Node.js, all the
[1:59] various things. Then they have different
[2:01] tools for packaging and
[2:04] it is impossible to actually code that.
[2:06] Like it will require a lot of coding.
[2:08] But if I just say a skill says
[2:12] please first figure out what their
[2:13] package manager is, then figure out what
[2:16] their ecosystem is, and then do these
[2:18] steps together with the user.
[2:20] You know, it's solved a lot more
[2:22] problems that we could ever code. So,
[2:24] that is another piece that I would say
[2:27] code is also transforming back into
[2:30] context as a skill as well, as a
[2:33] workflow that's reusable. And
[2:35] leave that with you.
[2:37] I like to think in parallels.
[2:39] In 2009, I don't know if there is any
[2:41] DevOps people in the room. It was kind
[2:43] of me saying like what if ops looked
[2:45] more like dev? And then we got like,
[2:47] hey, collaboration, kind of our
[2:49] deployment, all that stuff. So, kind of,
[2:52] you know, last year I started thinking,
[2:54] what if context
[2:56] is the code?
[2:58] How do we deal with this in a more
[3:00] consistent way?
[3:02] And
[3:04] it's basically saying if we have a
[3:05] software development life cycle
[3:08] how does a context development life
[3:10] cycle look like? Because we're basically
[3:12] shifting somewhere else. It's context,
[3:15] it's not code. How does it look like?
[3:18] I came up with this, you know, of course
[3:20] an infinity loop with some DevOps
[3:21] background. But the whole idea is that
[3:24] we generate a lot of context.
[3:26] Then hopefully we test the context. We
[3:29] distribute context maybe to some
[3:31] colleagues, to some other parts of the
[3:32] organization. We observe whether it
[3:35] works, and if it doesn't work or works,
[3:37] we call like, you know, adapt and
[3:39] regenerate the context and then go from
[3:41] there. So, that's kind of the
[3:43] loop of the talk that I'll be going for
[3:45] with some examples.
[3:47] So, step by step going through.
[3:50] Generate. It's probably the one that
[3:52] you're all most familiar with.
[3:55] Because you're all prompting.
[3:57] You're like the human context creation
[4:00] typing things, right? I was actually
[4:03] amazed that I just asked, tell me when
[4:05] my talk is at AI engineer, that it would
[4:07] fetch the website and it would just say,
[4:09] here's your talk. Like blew my mind. But
[4:12] hey, I I said like the context that I've
[4:13] given it, I'm Patrick, all that stuff,
[4:16] right? So, very simple context. It's
[4:18] what you do probably a lot in your
[4:20] setup.
[4:23] If you get a little bit more advanced,
[4:24] you say that prompting is tedious. I
[4:26] want to have reusable prompts. So, you
[4:29] know, depending on the flavor of your
[4:31] coding agents, they call it
[4:32] instructions.
[4:33] Luckily, there's a little bit of a
[4:35] standardization now happening where it's
[4:37] like an agent.md and some pieces like
[4:39] that. Boo Claude for still calling it
[4:42] Claude.md, but anyway, you get the
[4:44] picture. There's like reusable prompts,
[4:46] reusable pieces of context that we're
[4:48] doing.
[4:51] We can also bring other context in.
[4:54] If we have documentation of libraries
[4:56] that we use day to day
[4:58] we want to pull that in because the LLMs
[5:00] might not have the latest documentation.
[5:03] And so it's hallucinating. Is it version
[5:05] two, version three? We don't know. So,
[5:07] we give it a context and say, please
[5:09] download the documentation. Hopefully
[5:11] then agent optimized. And then they will
[5:14] do a better job at generating the code
[5:16] for that version of the library.
[5:18] Another piece of getting better context
[5:20] and creating context from libraries.
[5:24] And of course, it wouldn't be complete
[5:25] if we would say
[5:27] pull context from wherever. MC
[5:32] Get it from your GitLab, GitHub, kind of
[5:34] Slack.
[5:35] All context we're pulling in, we're
[5:37] creating. Even a ticket is creating
[5:39] context because we're pulling that in
[5:42] while we go there.
[5:45] And then maybe the new kid on the block
[5:47] is, okay, what if we
[5:49] start like writing our prompts as
[5:51] specification spec-driven development
[5:54] which then gets broken down by the agent
[5:56] into a planning mode into step by step
[5:58] kind of prompts that it then kind of
[6:01] runs through. So, a lot creation
[6:03] happening in that field.
[6:06] You know, simple. This is probably what
[6:08] you're closest to.
[6:10] But
[6:12] when you're typing all that context and
[6:14] creating all that context
[6:16] you change two lines in your Claude.md.
[6:19] Do you know the impact?
[6:21] Is it like YOLO? Looks good to me. Let's
[6:24] do it. You have to think about how do we
[6:27] test things?
[6:28] It's not just about we have a piece of
[6:31] code and we have a piece of context now.
[6:34] We need to write tests to see what is
[6:37] the impact. New coding agent? We don't
[6:39] know where the lines still work.
[6:42] Now, it's not new in the world of AI
[6:45] engineering but it's not that common yet
[6:48] in the world of coding with AI that you
[6:51] start writing evals for which are tests
[6:55] for your kind of code context.
[6:59] Uh a little bit hard to read, but you
[7:01] know, if you think in parallels
[7:03] we have different levels of testing in
[7:05] code, and the simple one could be
[7:08] linting. Your IDE is has the swiggly
[7:10] lines like, hey, this is not like, you
[7:12] know
[7:13] there's some
[7:14] incorrect syntax or you could do better
[7:16] like that.
[7:18] Here's an example of a validation of a
[7:20] skill where we say, well, you need to
[7:23] have the description. It can only be so
[7:25] long. So, it's validating according to
[7:28] the spec of the format of the context in
[7:30] this case.
[7:32] Simple analogy, simple linter that you
[7:35] can run.
[7:38] And then you can do other things like
[7:40] and and I haven't found maybe the good
[7:41] coding equivalent, but think of this as
[7:43] a Grammarly.
[7:45] Right? So, if you write context
[7:48] um
[7:49] is it actually can the agent understand
[7:52] what you're writing? If you write two
[7:54] words, it's not verbose enough for it to
[7:57] actually understand the context. So,
[7:59] what you can do is you can say ask is
[8:02] like, okay, you know, given this
[8:04] context, what do you think about Do you
[8:06] understand this? And then you can get
[8:08] feedback like,
[8:11] oh, it's not explicitly enough written
[8:15] or it's not complete. Like you're
[8:17] missing pieces. So, that's kind of from
[8:20] tools as well. So, whenever you're
[8:21] writing now your context, you get a
[8:24] Grammarly saying, hey
[8:26] do this. That's why I like to voice
[8:27] code. For some reason, I'm way more
[8:30] elaborate voice coding than typing. I'm
[8:32] a bad typer, two fingers
[8:34] still after so many years. But when I
[8:36] talk, I was like, you know, I see the
[8:38] the sentences come on the screen, but it
[8:40] helps to get good context there.
[8:43] All right, another kind of test.
[8:46] So, imagine you put in your Claude.md
[8:48] or agent.md, I should say. Now,
[8:51] um every API point must use the prefix
[8:54] awesome.
[8:56] Right? You have some convention in your
[8:57] company. Right? Which is great.
[9:00] So, your prompter will be then, add me a
[9:02] new endpoint to save a user.
[9:05] And you expect actually your coding
[9:08] agent to just say the code that's being
[9:10] generated has kind of {slash} awesome
[9:13] {slash} user.
[9:15] That's great.
[9:16] But the way we can test this is by
[9:19] asking then
[9:22] an LLM
[9:23] the code that was generated
[9:26] does it actually start with {slash}
[9:28] awesome? Now, you can do that with
[9:30] regex, I know. This is just for example
[9:32] purposes, but you can ask it to kind of
[9:35] judge your code based on your criteria
[9:38] and whether it did the right thing.
[9:40] Right? So, imagine you would ask the
[9:43] same question without your context
[9:45] above.
[9:47] No LLM is ever going to prefix your URL
[9:50] with awesome. So, that's kind of where
[9:52] your content or your company specific,
[9:54] your team specific things come in, and
[9:56] that's why you still write those tests
[9:58] to see if this still works. Now, maybe
